...
JSON_STRING=$( printf "$JSON_TEMPLATE" "$JETTY_PORT" "$JETTY_SECURE" "$JETTY_SSL_CLIENT_AUTH" "$JETTY_SSL_KEYSTORE_PATH" "$JETTY_SSL_KEYSTORE_PASSWORD" "$JETTY_SSL_KEYSTORE_MANAGER_PASSWORD" "$JETTY_SSL_TRUSTSTORE_PATH" "$JETTY_SSL_TRUSTSTORE_PASSWORD" )
